...
export const ProfileSettings = () => {
  ...
  const countries = [
    ...
    "Denmark", "Switzerland", "Singapore", "Other"
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {/* Non-editable fields */}
              <div>
                <Label htmlFor="name" className="text-gray-500">Name (Cannot be changed)</Label>
                <Input
                  id="name"
                  value={user?.name || ""}
                  disabled
              ...
              <div>
                <Label htmlFor="email" className="text-gray-500">Email (Cannot be changed)</Label>
                <Input
                  id="email"
                  value={user?.email || ""}
                  disabled
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {user?.role === "instructor" && (
                <div>
                  <Label htmlFor="expertise">Teaching Expertise (comma-separated)</Label>
                  <Textarea
                    id="expertise"
                    name="expertise"
              ...
              <div>
                ...
                <Select value={formData.profileVisibility} onValueChange={(value) => handleSelectChange("profileVisibility", value)}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="students-only">Students Only - Only enrolled students can see</SelectItem>
                  </SelectContent>
                </Select>
              </div>
