...
const AdminCoupons = () => {
  ...
  const fetchCoupons = async () => {
    const res = await axios.get("https://toperly.onrender.com/api/coupons");
    setCoupons(res.data);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await axios.put(
          `https://toperly.onrender.com/api/coupons/${editingId}`,
          {
            ...form,
        ...
        await axios.post("https://toperly.onrender.com/api/coupons", {
          ...form,
          course: form.course === "all" ? null : form.course,
        });
        setNotification({
  ...
  const handleDelete = async (id) => {
    if (confirm("Are you sure you want to delete this coupon?")) {
      setLoading(true);
      try {
        await axios.delete(`https://toperly.onrender.com/api/coupons/${id}`);
        setNotification({
