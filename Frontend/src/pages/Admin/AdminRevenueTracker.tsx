    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Comprehensive overview of course enrollment and revenue metrics</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Top Courses by Revenue</h3>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  data={topCoursesData}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900">Detailed Course Analytics</h3>
          </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {Object.entries(revenueData)
                  ...
                  <tr key={courseId} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      ₹{(data.totalRevenue / data.enrollCount).toLocaleString()}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <div className="flex items-center">
                        ...
                        <span className="text-xs">{data.avgProgress.toFixed(1)}%</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
