...
import { Upload, Play, Eye, Download, Users, FileImage, Video, Plus, X, LogOut, User, Shield } from 'lucide-react';
...
const MediaManagementSystem = () => {
  ...
  const authenticate = (role) => {
    setCurrentUser({ name: role === 'admin' ? 'Admin User' : 'Student User', role });
    setUserRole(role);
  };
...
useEffect(() => {
  const fetchMedia = async () => {
    try {
      ...
      const res = await fetch('http://localhost:5000/unsquare-toperly/images', {
        headers: {
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Media Portal</h1>
